...
const PrivacyPolicy = ({text}) => {
    return (
      <div className ='policy'>
        Effective date: January 01, 2021 Fashion House ("us", "we", or "our")
        operates the https://fashionhouse.com website (the "Service"). This
        page informs you of our policies regarding the collection, use, and
        disclosure of personal data when you use our Service and the choices you
        have associated with that data. Our Privacy Policy for Jad Joubran is
        based on the Free Privacy Policy Template Website. We use your data to
        ...
        Policy have the same meanings as in our Terms and Conditions, accessible
        from https://fashionhouse.com Information Collection And Use We
        collect several different types of information for various purposes to
        provide and improve our Service to you. Types of Data Collected Personal
        Data While using our Service, we may ask you to provide us with certain
        personally identifiable information that can be used to contact or
        identify you ("Personal Data"). Personally identifiable information:
        customerservice@fashionhouse.com fashionhouse FH Usage Data We may also
        collect information how the Service is accessed and used ("Usage Data").
        This Usage Data may include information such as your browser type,
        browser version, the pages of our Service that you visit, the time and
        date of your visit, the time spent on those pages, unique device
        identifiers and other diagnostic data. However, we anonymize your
        Internet Protocol address. Tracking & Cookies Data We use anonymous
        cookies to track the activity on our Service and hold certain
        ...
        to improve and analyze our Service. You can instruct your browser to
        ...
        of our Service. Examples of Cookies we use: Session Cookies. We use
        ...
        (Cloudflare, Stripe). Use of Data Fashion House uses the collected data
        for various purposes: To provide and maintain the Service To notify you
        about changes to our Service To allow you to participate in interactive
        features of our Service when you choose to do so To provide customer
        care and support To provide analysis or valuable information so that we
        can improve the Service To monitor the usage of the Service To detect,
        prevent and address technical issues Transfer Of Data Your information,
        including Personal Data, may be transferred to — and maintained on —
        ...
        those from your jurisdiction. If you are located outside Nepal and
        choose to provide information to us, please note that we transfer the
        data, including Personal Data, to Nepal and process it there. Your
        consent to this Privacy Policy followed by your submission of such
        information represents your agreement to that transfer. Fashion House
        ...
        security of your data and other personal information. Disclosure Of Data
        Legal Requirements Fashion House may disclose your Personal Data in the
        ...
        Joubran To prevent or investigate possible wrongdoing in connection with
        ...
        obligated not to disclose or use it for any other purpose. Analytics We
        may use third-party Service Providers to monitor and analyze the use of
        our Service. Google Analytics Google Analytics is a web analytics
        ...
        Service. This data is shared with other Google services. Google may use
        the collected data to contextualize and personalize the ads of its own
        advertising network. You can opt-out of having made your activity on the
        ...
        with Google Analytics about visits activity. For more information on the
        privacy practices of Google, please visit the Google Privacy & Terms web
        page: https://policies.google.com/privacy?hl=en Links To Other Sites Our
        ...
        customerservice@fashionhouse.com
      </div>
    );
}
